...
```{r gov-status}
# PSOE governa legislatures X-XI | PP governa legislatura XII
# TODO: Un cop el join de legislatura estigui fet:
# frames_df <- frames_df |>
#   mutate(
#     estatus_psoe = if_else(legislatura %in% c("X", "XI"), "Govern", "Oposició"),
#     estatus_pp   = if_else(legislatura == "XII", "Govern", "Oposició")
#   )
```
